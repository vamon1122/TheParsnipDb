...
/****** Object:  StoredProcedure [dbo].[sp_select_deleted_image]    Script Date: 05/12/2019 21:36:42 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[sp_select_deleted_image] 
...
BEGIN
	...
	WHERE 
		...
		AND vw_image.datetime_image_deleted IS NOT NULL	
END
GO
