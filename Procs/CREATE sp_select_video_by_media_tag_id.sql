...
/****** Object:  StoredProcedure [dbo].[sp_select_video_by_media_tag_id]    Script Date: 05/12/2019 21:38:17 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[sp_select_video_by_media_tag_id] 
...
BEGIN
	...
	WHERE 
		vw_video.datetime_user_deleted IS NULL 
		AND vw_video.datetime_video_deleted IS NULL	
		AND vw_video.media_tag_id = @media_tag_id	
END
GO
