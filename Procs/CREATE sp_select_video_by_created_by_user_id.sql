...
/****** Object:  StoredProcedure [dbo].[sp_select_video_by_created_by_user_id]    Script Date: 05/12/2019 21:38:04 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[sp_select_video_by_created_by_user_id] 
...
BEGIN
	...
	WHERE  
		vw_video.datetime_video_deleted IS NULL	
		AND vw_video.created_by_user_id = @created_by_user_id	
END
GO
