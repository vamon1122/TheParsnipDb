...
/****** Object:  StoredProcedure [dbo].[sp_select_youtube_video_by_media_tag_id]    Script Date: 05/12/2019 21:38:48 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[sp_select_youtube_video_by_media_tag_id] 
...
BEGIN
	...
	SELECT 
		...
		vw_youtube_video.datetime_created AS datetime_youtube_video_created, 
    ...
    WHERE 
		...
		AND vw_youtube_video.media_tag_id = @media_tag_id
END
GO
