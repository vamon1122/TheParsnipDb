/****** Object:  View [dbo].[vw_media_tag_pair]    Script Date: 27/03/2020 22:07:37 ******/
SET ANSI_NULLS ON
GO
...
SELECT        dbo.media_tag_pair.media_id, dbo.media_tag_pair.media_tag_id, dbo.media_tag_pair.created_by_user_id AS media_tag_pair_created_by_user_id, dbo.media_tag_pair.datetime_deleted AS media_tag_pair_datetime_deleted, 
                         ...
                         media_tag_created_by_user.datetime_deleted AS media_tag_created_by_user_datetime_deleted, dbo.media_tag.is_album AS media_tag_is_album, dbo.media_tag.name AS media_tag_name, 
